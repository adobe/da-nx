...
import { fetchSiteSourceText } from '../skills-editor-api.js';

const styles = await loadStyle(import.meta.url);

/**
 * Generated Tools panel for the DA Skills Editor.
 *
...
class NXGeneratedTools extends LitElement {
  ...
  async _runMatchedTool() {
    ...
    try {
      ...
      const result = await executor({ html: raw, text: raw, content: raw });
