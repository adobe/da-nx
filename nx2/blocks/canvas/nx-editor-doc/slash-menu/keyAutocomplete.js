...
let autocompleteData = new Map();

export function getAutocompleteData() {
  return autocompleteData;
}

export function setKeyAutocomplete(keyMap) {
  autocompleteData = keyMap instanceof Map ? keyMap : new Map();
}

export async function getKeyAutocomplete() {
  return autocompleteData;
}
