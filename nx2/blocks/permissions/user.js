...
const ICONS = [
  `${new URL(import.meta.url).origin}/nx/public/icons/S2_Icon_Add_20_N.svg`,
  `${new URL(import.meta.url).origin}/nx/public/icons/S2_Icon_Checkmark_20_N.svg`,
  `${new URL(import.meta.url).origin}/nx/public/icons/S2_Icon_Close_20_N.svg`,
];
...
class NxPermissionUser extends LitElement {
  ...
  async connectedCallback() {
    ...
    const { default: getSvg } = await import(`${nxBase}/utils/svg.js`);
