const MESSAGES = {
  ...
  INDEX_MISSING_PLUGIN: 'No media index for this site yet.',
  INDEX_MISSING_PLUGIN_HINT: 'Discovery runs in the full Media Library app. Open it in a new tab to run discovery.',
  INDEX_MISSING_PLUGIN_OPEN: 'Open Media Library app',
  ...
  NOTIFY_INSERTED: 'Inserted',
  NOTIFY_INSERTED_IMAGE: 'Image inserted into the document.',
  NOTIFY_INSERTED_URL: 'Link inserted into the document.',
  NOTIFY_PLUGIN_FALLBACK_HEADING: 'Paste in document',
  NOTIFY_PLUGIN_FALLBACK_LINK_MSG: 'Rich link copied (direct insert unavailable). Press Ctrl+V or ⌘V.',
  NOTIFY_PLUGIN_FALLBACK_IMAGE_MSG: 'Image copied (direct insert unavailable). Press Ctrl+V or ⌘V.',
  NOTIFY_PLUGIN_FALLBACK_PLAIN_MSG: 'URL copied (direct insert unavailable). Press Ctrl+V or ⌘V.',
  ...
  UI_PDF_LOADING: 'Loading PDF preview...',
  UI_PDF_FAILED: 'Failed to load PDF',
  UI_PDF_HTTP_ERROR: 'Unable to load PDF ({status})',
  UI_PDF_INVALID_TYPE: 'Server did not return a PDF file',
  UI_PDF_INACCESSIBLE: 'Failed to load PDF. It may be inaccessible.',
  UI_PDF_LOADING_ARIA: 'Loading PDF',
