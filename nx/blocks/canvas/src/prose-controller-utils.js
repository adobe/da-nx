/**
 * Change-detection helpers for quick-edit controller mode.
 * Adapted from da-nx nx/blocks/quick-edit-portal/src/utils.js
 * (findChangedNodes, findCommonEditableAncestor).
 */
